<?php
  ...
  if(isset($_POST['btn_send']))
  {
   ...
   try
   {
    ...
    $mail->Username   ="saurabhk201@gmail.com";  
                         $mail->Password   ="webindia@2020";            
                         $mail->SetFrom('saurabhk201@gmail.com','Coding Cage');
                         $mail->AddReplyTo("saurabhk201@gmail.com","Coding Cage");
...
<footer class="footer">
      <div class="container">
        <p class="text-muted">&copy; copyright, <a href="http://www.codingcage.com" target="_blank">www.codingcage.com</a></p>
      </div>
</footer>
